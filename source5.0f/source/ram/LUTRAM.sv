...
`endif
    ...
    localparam int NUM_WORDS  = NUM_BYTES * BYTE_WIDTH / WORD_WIDTH,// 16
    localparam int ADDR_WIDTH = $clog2(NUM_WORDS),  // 2, 3 or 4       4
    localparam int LANE_WIDTH = BYTE_WRITE ? BYTE_WIDTH : WORD_WIDTH,//8
    localparam int NUM_LANES  = WORD_WIDTH / LANE_WIDTH,//4
    localparam int NUM_BITS   = NUM_BYTES * BYTE_WIDTH,//64*8
    ...
    localparam type rstrobe_t = logic  [NUM_LANES  - 1:0],//4

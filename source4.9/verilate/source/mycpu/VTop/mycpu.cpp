...
auto MyCPU::get_writeback_pc() const -> addr_t {
     ...
     */
    return VTop->core__DOT__veri_pc;
    //return 0x19260817;
}
...
auto MyCPU::get_writeback_value() const -> addr_t {
     ...
     */
    return VTop->core__DOT__wr_word;
    //return 0xdeadbeef;
}
...
auto MyCPU::get_writeback_wen() const -> word_t {
     ...
     */
    auto wab=VTop->core__DOT__write_enable;
    return (wab<<3)|(wab<<2)|(wab<<1)|wab;
